...
/** In-memory key used by content script to show once per URL per page load. */
export const autoSurfaceShownInMemoryKey = (siteId: string, href: string): string =>
  `shopfriend:autoSurface:shown:in-memory:${siteId}:${href}`
